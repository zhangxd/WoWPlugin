...
def validate_settings_host() -> None:
    ...
    for needle, label in [
        ...
        ('CreateFrame("CheckButton", nil, parentFrame, "SettingsCheckboxTemplate")', "native settings checkbox template"),
        ('CreateFrame("Frame", nil, parentFrame, "SettingsDropdownWithButtonsTemplate")', "native settings dropdown with buttons template"),
