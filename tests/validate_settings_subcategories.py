...
def validate_encounter_journal_questline_tree_feature() -> None:
    ...
    require_contains(questline_api_text, "expansions", "questline api reads decoupled expansion buckets")
    require_contains(data_text, "expansions = {", "questline data uses expansion buckets")
    require_contains(data_text, "indexes = {", "questline data provides compact indexes")
