...
Toolbox.Data.NavigationAbilityTemplates = {
  ...
  templates = {
    ...
    ["spell_88344"] = { TemplateID = "spell_88344", Mode = "class_teleport", SpellID = 88344, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 235, Label = "传送：托尔巴拉德", SelfUseOnly = true },
    ["spell_88345"] = { TemplateID = "spell_88345", Mode = "class_portal", SpellID = 88345, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 235, Label = "传送门：托尔巴拉德", SelfUseOnly = true },
    ["spell_88346"] = { TemplateID = "spell_88346", Mode = "class_portal", SpellID = 88346, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 235, Label = "传送门：托尔巴拉德", SelfUseOnly = true },
    ["spell_120146"] = { TemplateID = "spell_120146", Mode = "class_portal", SpellID = 120146, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 487, Label = "远古传送门：达拉然", SelfUseOnly = true },
    ["spell_132620"] = { TemplateID = "spell_132620", Mode = "class_portal", SpellID = 132620, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 379, Label = "传送门：锦绣谷", SelfUseOnly = true },
    ["spell_132621"] = { TemplateID = "spell_132621", Mode = "class_teleport", SpellID = 132621, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 379, Label = "传送：锦绣谷", SelfUseOnly = true },
    ["spell_132626"] = { TemplateID = "spell_132626", Mode = "class_portal", SpellID = 132626, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 379, Label = "传送门：锦绣谷", SelfUseOnly = true },
    ...
    ["spell_281400"] = { TemplateID = "spell_281400", Mode = "class_portal", SpellID = 281400, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 965, Label = "传送门：伯拉勒斯", SelfUseOnly = true },
    ["spell_281402"] = { TemplateID = "spell_281402", Mode = "class_portal", SpellID = 281402, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 969, Label = "传送门：达萨罗", SelfUseOnly = true },
    ["spell_281403"] = { TemplateID = "spell_281403", Mode = "class_teleport", SpellID = 281403, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 965, Label = "传送：伯拉勒斯", SelfUseOnly = true },
    ["spell_281404"] = { TemplateID = "spell_281404", Mode = "class_teleport", SpellID = 281404, ClassFile = "MAGE", FactionGroup = "Horde", TargetRuleKind = "fixed_node", ToNodeID = 969, Label = "传送：达萨罗", SelfUseOnly = true },
    ["spell_344587"] = { TemplateID = "spell_344587", Mode = "class_teleport", SpellID = 344587, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 1167, Label = "传送：奥利波斯", SelfUseOnly = true },
    ["spell_344597"] = { TemplateID = "spell_344597", Mode = "class_portal", SpellID = 344597, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 1167, Label = "传送门：奥利波斯", SelfUseOnly = true },
    ["spell_395277"] = { TemplateID = "spell_395277", Mode = "class_teleport", SpellID = 395277, ClassFile = "MAGE", FactionGroup = nil, TargetRuleKind = "fixed_node", ToNodeID = 1406, Label = "传送：瓦德拉肯", SelfUseOnly = true },
