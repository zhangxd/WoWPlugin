...
| TC-MANUAL-23 | 打开设置页“任务”叶子页中的 Quest Inspector 工具区 | 输入合法 `QuestID` 并点击查询 | 页面显示可复制结果文本；若需要异步加载，则在加载后自动刷新 |
...
| 2026-04-29 | 设置宿主重构对齐：Quest Inspector 的手工验证入口改为“任务”叶子页内工具区 |
